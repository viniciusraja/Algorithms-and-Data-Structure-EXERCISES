// // // You have to build a rudimentary architecture that will simulate a system of XP points distribution among two 
// students that solve a series of given challenges on Edabit.
...
// // Now that everything is ready, you have to set the exercise and declare the instances of the created classes,
//  for sustaining the tests that are made. Start with the users declarations, they are two:
...
// // Finally, you have to declare which are the challenges solved by the users, using the setter that you have
//  implemented before:
...
// // Tests will verify if after calling the properties and methods of the instance created by you, 
// an expected result is returned. So, you don't have to return a result, but just being sure that everything is
